...
# PJW. Changed 'multithread = T' to 'multithread = 16'
# See filterAndTrim help file in R, particularly qualityType =
res_filt <- filterAndTrim(input$absolute.filepath, filt, maxN = 0, maxEE = opt$maxEE, truncQ = opt$truncQ, truncLen = opt$truncLen, minLen = opt$minLen, maxLen = opt$maxLen, compress = T, multithread = 16, verbose = opt$verbose)
